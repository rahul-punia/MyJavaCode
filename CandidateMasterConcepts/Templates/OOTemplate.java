...
//Object Oriented Standard Template
//First make a new class 
//Then make an object of new class 
//Then call/invoke method on that object.

 class myclass{ //donot make this class public 
    public void solve() throws Exception{
       ...
       while(t-->0){
        ...
        int[] arr=new int[n];
        for(int i=0;i<n;i++){arr[i]=Integer.parseInt(strs[i]); }  //asb.append(arr[i]+" ");
...
//******************************************************************************************************************** */
    ...
    public  long binexp(long a, long b, long m){
        if (b == 0)return 1; 
	...
	public  void print(long[] dp) {//Method Overloading
		for (long val : dp) {
			System.out.print(val + " ");
		}
		System.out.println();
