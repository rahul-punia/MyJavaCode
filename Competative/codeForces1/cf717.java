...
public class cf717 {
    ...
    public static void solve() throws Exception{
       ...
       while(t-->0){
        ...
        // long n=Long.parseLong(strs[0]),k=Long.parseLong(strs[1]);//,r=Long.parseLong(strs[2]),s=Long.parseLong(strs[3]);
    ...
    public static void main(String[] args) throws Exception{
     ...
     public static void solve2() throws Exception{
       ...
       while(t-->0){
        ...
        // String[] strs=(br.readLine()).trim().split(" ");
        // long n=Integer.parseInt(strs[0]),l=Integer.parseInt(strs[1]),r=Integer.parseInt(strs[2]),s=Integer.parseInt(strs[3]);
        //  String str=(br.readLine()).trim();
